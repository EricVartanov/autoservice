            ...
            <AnimatePresence mode="wait" custom={direction}>
                ...
                >
                   <div className={'flex flex-col items-start justify-between gap-6'}>
                       <h3 className="font-heading font-bold text-foreground-fixed text-4xl whitespace-pre-line">
                           {slide.title}
                       </h3>
                       <span className={'w-[50] block border-b-foreground-fixed border h-[1]'}></span>
                       <p className="text-foreground-fixed font-helvetica text-lg leading-5">{slide.text}</p>
                   </div>
                </motion.div>
            </AnimatePresence>
        </div>
