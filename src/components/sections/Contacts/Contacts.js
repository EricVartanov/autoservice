...
export default function Contacts({data}) {
    ...
    return (
        <section className="relative overflow-hidden py-20 md:py-[150]">
            <Container className={'relative'}>
                <div className="absolute z-20 left-1/2 transform -translate-x-1/2 top-0 flex justify-center">
                    <a
                        href={`mailto:${email}`}
                ...
                <Image
                    ...
                    width={602}
                    height={561}
                    className="absolute left-1/2 bottom-0 -translate-x-1/2  z-10 w-full max-w-[600] h-auto dark:invert"
                />
