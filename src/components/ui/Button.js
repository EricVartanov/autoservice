export default function Button({
    ...
    const variants = {
        primary: 'bg-primary border border-primary hover:bg-transparent text-foreground-fixed min-w-[160] h-[40] md:h-[54] md:min-w-[213] px-3 py-2.5 md:py-3.5',
        ...
        transparent: 'font-bold font-helvetica px-3 md:px-5 py-2.5 md:py-3.5 border border-btn-border h-[40] md:h-[54] min-w-[160] md:min-w-[213]',
